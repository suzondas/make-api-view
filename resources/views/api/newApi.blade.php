            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <tr v-for="(item, index) in apiData.keys">
                                    ...
                                    <td>
                                        ...
                                        <div class="mt-1" v-if="item.option==2">
                                            ...
                                            <input type="text" v-model="item.reference_api_response_key" :disabled="item.reference_api_id==''"/>
                                        </div>
                                    </td>
                            ...
                            Name of this Api to save: <input type="text" class="form-control w-50" v-model="apiData.name"/><br><br>
                        </div>
                    </div>
                    <div class="card-footer">
                        <input type="button" class="btn btn-success" value="Save" @click="validate"/>
                    </div>
                </div>
            </div>
    </div>
@endsection
@section('javascript')
    <script>var reference_apis = '<?php echo $reference_apis;?>'</script>
    <script src="{{ asset('js/newApi.js') }}" type="module"></script>
@stop
